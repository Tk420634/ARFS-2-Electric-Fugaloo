...
/var/list/meteors_normal = list(/obj/effect/meteor/dust=2, /obj/effect/meteor/medium=6, /obj/effect/meteor/big=2, \
						  /obj/effect/meteor/irradiated=1) //for normal meteor event

/var/list/meteors_threatening = list(/obj/effect/meteor/medium=3, /obj/effect/meteor/big=4, \
						  /obj/effect/meteor/flaming=1, /obj/effect/meteor/irradiated=2, /obj/effect/meteor/emp=2) //for threatening meteor event
