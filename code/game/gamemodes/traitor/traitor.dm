/datum/game_mode/traitor
	...
	extended_round_description = "The Company's majority control of starmaps in the system has marked the \
		...
		Is the ship the safe self-contained workplace you once thought it was, or has it become a playground \
