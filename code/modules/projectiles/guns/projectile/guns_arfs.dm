//The point of this additional file for guns that're ARFS specific is so, if we happen to update to Virgo or something (like i've suggested)
//all of these guns wouldn't go *poof*.
//I VERY HIGHLY SUGGEST DOING MORE LIKE THIS. REALLY. IT HELPS. A LOT.
//also, i have critical autism so lots of this stuff is hacky as fuck, and i legit don't give a fuck as long as it works
