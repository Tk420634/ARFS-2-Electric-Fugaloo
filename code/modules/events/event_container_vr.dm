...
//TK here, I added Lost Carp and Supply demand back into the normal event chain.  I did remove PDA Spam though, because Jesus fucking shitposting christ that event is annoying as hell.
...
//Tk Here, I've placed most of the events back into rotation.  Specifically all events after, and including, Appendicitis.
...
//TK here, I turned back on Carp Migration, Space Vines (sure, why not), and Supply Demand.  I'm not sure how vines work in this code, but if we need to turn them back off we of course can.
