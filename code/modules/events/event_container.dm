...
/datum/event_container/mundane
	...
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "APC Damage",		/datum/event/apc_damage,		25, 	list(ASSIGNMENT_ENGINEER = 20)),
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Space Dust",		/datum/event/dust	, 			80, 	list(ASSIGNMENT_ENGINEER = 20), 0, 0, 50),
...
/datum/event_container/moderate
	...
	available_events = list(
		...
		/* new /datum/event_meta(EVENT_LEVEL_MODERATE, "Spider Infestation",		/datum/event/spider_infestation, 		0,	list(ASSIGNMENT_SECURITY = 0), 0), */
